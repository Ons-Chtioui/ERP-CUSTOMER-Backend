...
let BomLine = class BomLine {
    id;
    product;
    component;
    quantity;
};
exports.BomLine = BomLine;
__decorate([
    (0, typeorm_1.PrimaryGeneratedColumn)('increment'),
    __metadata("design:type", Number)
], BomLine.prototype, "id", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => product_entity_1.Product, (p) => p.bomLines, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'product_id' }),
    __metadata("design:type", product_entity_1.Product)
], BomLine.prototype, "product", void 0);
__decorate([
...
exports.BomLine = BomLine = __decorate([
    (0, typeorm_1.Entity)('bom_lines'),
    (0, typeorm_1.Unique)(['product', 'component'])
], BomLine);
//# sourceMappingURL=bom-line.entity.js.map