...
exports.CreateTransferDto = exports.CreateMovementDto = void 0;
...
], CreateMovementDto.prototype, "referenceDoc", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateMovementDto.prototype, "notes", void 0);
class CreateTransferDto extends CreateMovementDto {
    targetWarehouseId;
}
...
__decorate([
    ...
    (0, class_validator_1.IsInt)(),
    __metadata("design:type", Number)
], CreateTransferDto.prototype, "targetWarehouseId", void 0);
