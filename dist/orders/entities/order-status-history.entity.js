...
__decorate([
    (0, typeorm_1.ManyToOne)(() => order_entity_1.Order, (o) => o.statusHistory, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'order_id' }),
    __metadata("design:type", order_entity_1.Order)
], OrderStatusHistory.prototype, "order", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'from_status', type: 'varchar', nullable: true }),
    __metadata("design:type", Object)
], OrderStatusHistory.prototype, "fromStatus", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'to_status', type: 'varchar' }),
